...
@section('search')
 ...
 <ul class="navbar-nav w-100">
    <li class="nav-item w-100">
      ...
      <form  action="{{url('payment_orders_history_search')}}" method="GET" class="nav-link mt-2 mt-md-0  d-lg-flex search">
        {{csrf_field()}}
                ...
                <div class="col-md-12">
                    ...
                    <div class="card p-4" style="overflow: auto">
                        ...
                        <div class="mb-3" style="display: flex; justify-content: space-between;">
                            ...
                            <div>
                                <a href="{{ 'admin_payment_online' }}" class="btn btn-success">Order </a>
                            </div>
                        </div>
                        ...
                        <div class="table-wrapper" style="overflow: auto">
                            ...
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link " aria-current="page" href="{{ url('/home') }}">Hand Cash</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ url('admin_payment_online') }}">Payment Online</a>
                                </li>
                            </ul>
                                ...
                                <div class="product">
                                    <table width="100%" class="table display responsive nowrap text-white">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $i = $order_payment->perPage() * ($order_payment->currentPage() - 1); ?>
                                            ...
                                            @foreach ($order_payment as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('admin_payment_orders_view/' . $row->id) }}"
                                                            class="btn btn-sm btn-success"><i
                                                                class="fa fa-eye"></i></a>
                                                        <a href="{{ url('admin_payment_orders_delete/' . $row->id) }}"
