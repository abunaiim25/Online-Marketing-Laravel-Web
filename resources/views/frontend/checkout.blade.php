                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bg-white " style="color: black" type="text" name="shipping_name" placeholder="name" value="{{ Auth::user()->name }}" readonly>
                                        @error('shipping_name')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bg-white " style="color: black" type="text" name="shipping_email" placeholder="email" value="{{ Auth::user()->email }}" readonly>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bg-white " style="color: black" type="text" name="shipping_phone" placeholder="phone" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control bg-white " style="color: black" type="text" name="address" placeholder="address" required>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label">Country/State: <span class="text-danger">*</span></label>
                                        <input class="form-control bg-white " style="color: black" type="text" name="state" placeholder="country/state" required>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label">Zip Code: <span class="text-danger">*</span></label>
                                        <input class="form-control bg-white " style="color: black" type="text" name="post_code" placeholder="zip code (integer type)" required>
                                    </div>
                                </div>
                            ...
                            <div class="card p-3" style="background: blanchedalmond">
                                ...
                                <div class="d-flex justify-content-between  ">
                                    ...
                                    <p>{{ session()->get('discount')['discount_percentage'] }}% (
                                        {{ session()->get('discount')['discount_amount'] }} tk )
                                    </p>
                                </div>
                                ...
                                <div class="checkout__input__checkbox">
                                    <label for="payment">
                                        <p><small> HansCash</small>
                                            <input type="radio" value="HandCash" name="payment_type" style="color: black" required>
                                        </p>
                                        {{--
...
--}}
                                ...
                                <a href="{{ url('example2') }}" type="submit" class="btn button-style text-white">Online Payment</a>
