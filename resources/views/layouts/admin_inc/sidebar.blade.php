    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic3">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{url('admin_descriptoon_add')}}">Description</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{url('admin_team_add')}}">Add Our Team</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{url('admin_team_manage')}}">Manage Our Team</a>
                    </li>
                </ul>
            </div>
        </li>
